...
public class TestConfig {
	...
	public static String messageBody = "Level 2 monitoring script has been failed on production. Please check the logs report and attached screenshot for analyzing the root cause."
			+ " <br><br><b>Link for this validation</b>"
			+ "<br>"
			+ "http://"
			+ TestUtil.Handeler()
			+ ":8282"
			...
			+ DriverApp.strDate
			+ ".html"
			+ "<p> <b>To search for previous validation results</b><br>http://"
			+ TestUtil.Handeler()
			+ ":8282"
			+ "/ReportView.jsp </p>"
			+ "<p> <b>Link to the CPV Guide</b><br></p>"
			+ "<br>"
	...
	// attachmentPath="C:/Selenium3.0/app/test/Framework/AutomationBvt_Hybrid/Reports.zip";
	// public static String
	// attachmentPath="C:/Selenium3.0/app/test/Framework/testweb/WebContent/webpages/index"+DriverScript.year+"_"+DriverScript.date+"_"+(DriverScript.month+1)+"_"+DriverScript.day+"_"+DriverScript.min+"_"
	// +DriverScript.sec+".html";
	// public static String
	// attachmentPath="C:/Selenium3.0/app/test/Framework/testweb/WebContent/webpages/index"+DriverScript.year+"_"+DriverScript.date+"_"+(DriverScript.month+1)+"_"+DriverScript.day+"_"+DriverScript.min+"_"
	// +DriverScript.sec+".html";
	// public static String
	// attachmentPath="C:/CMAutomation/tomcat-6.0/webapps/ROOT/screenshots/"+DriverScript.mailscreenshotpath+".jpeg";
	public static String attachmentPath = DriverApp.mailscreenshotpath
			+ ".jpeg";
	public static String attachmentName = "Error.jpeg";
	// public static String
	// filepath="C:/Selenium3.0/app/test/Framework/testweb/WebContent/webpages";
