...
public class TestReports {
	...
	public static void startTesting(String filename, String testStartTime,
		...
		try {
			...
			out.write("<td width=150 align=left><FONT COLOR=black FACE=Arial SIZE=2.75><b>"
					+ RUN_DATE + "</b></td>\n");
			out.write("</tr>\n");
			out.write("<tr>\n");
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<h4> <FONT COLOR=black FACE= Arial  SIZE=4.5> <u>"
	...
	public static void addTestCase(String testCaseName,
		...
		try {
			...
			if (status.equalsIgnoreCase("Skipped")
				...
				File f = new File(currentDir + "//" + currentSuiteName + "_TC"
						+ tcid + "_" + testCaseName.replaceAll(" ", "_")
						+ DriverApp.year + "_" + DriverApp.date + "_"
						+ (DriverApp.month + 1) + "_" + DriverApp.day + "_"
						+ DriverApp.min + "_" + DriverApp.sec + ".html");
				// File f = new
				...
				fstream = new FileWriter(currentDir + "//" + currentSuiteName
						+ "_TC" + tcid + "_"
						+ testCaseName.replaceAll(" ", "_") + DriverApp.year
						+ "_" + DriverApp.date + "_" + (DriverApp.month + 1)
						+ "_" + DriverApp.day + "_" + DriverApp.min + "_"
						+ DriverApp.sec + ".html");
				// fstream = new
				...
				if (description != null) {
					for (int i = 0; i < description.size(); i++) {
						...
						out.write("<td align=center width=10%><FONT COLOR=black FACE=Arial SIZE=1><b>TS"
								+ (i + 1) + "</b></td>");
						out.write("<td align=center width=50%><FONT COLOR=black FACE=Arial SIZE=1><b>"
								+ description.get(i) + "</b></td>");
						out.write("<td align=center width=10%><FONT COLOR=black FACE=Arial SIZE=1><b>"
								+ keyword.get(i) + "</b></td>");
						if (teststatus.get(i).startsWith("Pass")) {
							out.write("<td width=20% align= center  bgcolor=#BCE954><FONT COLOR=black FACE=Arial SIZE=2><b>"
									+ teststatus.get(i) + "</b></td>\n");
						} else if (teststatus.get(i).startsWith("Fail")) {

							out.write("<td width=20% align= center  bgcolor=Red><FONT COLOR=black FACE= Arial  SIZE=2><b>"
									+ teststatus.get(i) + "</b></td>\n");
						}
			...
			out.write("<td width=10% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b>"
					+ scriptNumber + "</b></td>\n");
			if (status.equalsIgnoreCase("Skipped")
					|| status.equalsIgnoreCase("Skip"))
				out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b>"
						+ testCaseName + "</b></td>\n");
			else
				// out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ",
				...
				out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=http://"
						...
						+ testCaseName
						+ "</a></b></td>\n");
			// out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href="+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ",
			...
			if (status.startsWith("Pass"))
				...
				out.write("<td width=10% align= center  bgcolor=Red><FONT COLOR=black FACE= Arial  SIZE=2><b>"
						+ status + "</b></td>\n");
			...
			out.write("<td width=20% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b>"
